...
use App\Models\Event;        //  TAMBAHAN MODUL: Import Model Event
use App\Models\Transaction;  //  TAMBAHAN MODUL: Import Model Transaction
...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        // 6. Mengirimkan seluruh variabel ringkasan ke view admin.dashboard
