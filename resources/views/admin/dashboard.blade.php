...
@section('content')
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
        ...
        <div class="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm">
            ...
            {{-- 🔑 DINAMIS: Cetak nominal rupiah hasil sum() dari database --}}
        ...
        <div class="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm">
            ...
            {{-- 🔑 DINAMIS: Cetak kuantitas pesanan berstatus sukses --}}
        ...
        <div class="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm">
            ...
            {{-- 🔑 DINAMIS: Jumlah acara yang tanggalnya >= hari ini --}}
        ...
        <div class="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm">
            ...
            {{-- 🔑 DINAMIS: Jumlah transaksi yang masih menunggu pembayaran --}}
    ...
    <div class="bg-white rounded-3xl border border-slate-100 shadow-sm overflow-hidden">
        <div class="p-8 border-b flex justify-between items-center">
            ...
            {{-- 🎯 FIX LINK: Mengarah ke rute indeks riwayat data transaksi admin secara menyeluruh --}}
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y border-t">
                    {{-- 🔄 PROSES LOOPING PERULANGAN DATA RIWAYAT DARI CONTROLLER --}}
